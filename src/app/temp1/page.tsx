    ...
    return (
      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
              ...
              <blockquote>
                  <p className="sm:text-2xl text-xl font-medium text-gray-900 dark:text-white">
                  &quot;Your success is our purpose. At MI Lab, we don&apos;t just deliver services—we build partnerships that drive growth, ensure compliance, and create lasting value.&quot;</p>
              </blockquote>
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  <img className="w-12 h-12 rounded-full " src="/logo.png" alt="profile picture"></img>
                  <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                      <div className="pr-3 font-medium text-gray-900 dark:text-white">Dr.Tarini Shankar Ghosh</div>
                      <div className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Proprietor</div>
                  </div>
              </figcaption>
          </figure>
      </div>
...
const Quote2 = () => {
    return (
      <section className="bg-blue-700 rounded-xl">
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
              ...
              <blockquote>
                  <p className="sm:text-2xl text-xl font-medium text-white">
                  &quot;Your success is our purpose. At MI Lab, we don&apos;t just deliver services—we build partnerships that drive growth, ensure compliance, and create lasting value.&quot;</p>
              </blockquote>
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  <img className="w-12 h-12 rounded-full " src="/logo.png" alt="profile picture"></img>
                  <div className="flex items-center divide-x-2 divide-gray-200">
                      <div className="pr-3 font-medium text-white"> Dr.Tarini Shankar Ghosh</div>
                      <div className="pl-3 text-sm font-light text-gray-200">Proprietor</div>
                  </div>
              </figcaption>
          </figure>
      </div>

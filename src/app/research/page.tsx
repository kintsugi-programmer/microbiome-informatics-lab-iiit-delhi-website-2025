...
const Research = () => {
  return (
    <div className='bg-white py-40 h-full text-black px-12'>
      ...
      <div className='mx-auto max-w-screen-xl text-justify flex flex-col pt-12 gap-12'>
        ...
        <div className='flex flex-col md:flex-row gap-6 md:gap-12'>
          <div className="w-full md:w-[30%] flex items-center justify-center">
            <div className="relative w-72 h-72 sm:w-96 sm:h-96 md:w-[20rem] md:h-[20rem]">
              <Image
                src="/art/7.png"
                alt="img"
                fill
          ...
          <div className="w-full md:w-[70%]">
            <div className="flex justify-center sm:justify-start">
              <div className="text-justify text-2xl font-semibold leading-tight sm:text-3xl sm:leading-tight md:text-2xl md:leading-tight md:text-start">
                1. Unravelling the basis of assembly, resilience and stability of&nbsp;
        ...
        <div className='flex flex-col md:flex-row gap-6 md:gap-12'>
          <div className="w-full md:w-[70%]">
            <div className="flex justify-center sm:justify-start">
              <div className="text-center text-2xl font-semibold leading-tight sm:text-3xl sm:leading-tight md:text-2xl md:leading-tight md:text-start">
                2. Understanding the tripartite interactions between microbiome, host demographics and external environments/interventions like diet
              </div>
            </div>
            <div className='pt-4'>
        ...
        <div className='flex flex-col md:flex-row gap-6 md:gap-12'>
          ...
          <div className="w-full md:w-[70%]">
            <div className="flex justify-center sm:justify-start">
              <div className="text-justify text-2xl font-semibold leading-tight sm:text-3xl sm:leading-tight md:text-2xl md:leading-tight md:text-start">
               3. Data-driven functional metagenomics of the human microbiome for better mechanistic insights into disease-microbiome interactions and better microbiome-derived disease diagnostics
              </div>
            </div>
            <div className='pt-4'>
...
Under this theme, we aim to investigate the above aspect by performing functional genomic characterization of gut microbiome members and utilize these to build microbiome-derived diagnostic classifiers for different diseases and disorders. The second objective is to investigate these alterations and strive to delineate the microbiome alterations into cause and effect classes.            </div>
        ...
        <div className='flex flex-col md:flex-row gap-6 md:gap-12'>
          <div className="w-full md:w-[70%]">
            <div className="flex justify-center sm:justify-start">
              <div className="text-center text-2xl font-semibold leading-tight sm:text-3xl sm:leading-tight md:text-2xl md:leading-tight md:text-start">
4. Exploring the human microbiome besides the gut
              </div>
            </div>
            <div className='pt-4'>

...
const Research = () => {
  return (
    <div className='bg-white py-20 h-full text-black px-12'>
      <h1 className="bg-opacity-50 bg-gradient-to-b from-neutral-400 to-neutral-900 bg-clip-text text-center text-3xl sm:text-4xl font-extrabold leading-tight mb-2">
        ...
        &nbsp;
        <span className='bg-opacity-50 bg-gradient-to-b from-neutral-400 to-neutral-900 bg-clip-text text-center text-3xl sm:text-4xl font-extrabold leading-tight mb-2'>@IIIT Delhi</span>
      </h1>
